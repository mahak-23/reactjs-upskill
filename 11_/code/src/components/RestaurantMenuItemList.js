          ...
          >
            ...
            <div className="flex flex-col items-center justify-center">
              <img
                ...
                alt={name}
              />
              <button className="text-[#ff8c00] bg-white font-semibold rounded-md text-[1.2rem] px-[30px] py-[5px] cursor-pointer border-none relative bottom-[15px] hover:bg-gray-300 hover:text-[#ff8c00] transition-all 0.3s">
                ADD
              </button>
            </div>
          </div>
