...
// const heading = React.createElement("h1", { id: "heading" }, "Top heading 🚀");
...
/**
 * JSX- not html or xml but it's like syntax
...
// const jsxHeading = <h1 id="heading">Top heading using JSX 🚀</h1>;
// const root = ReactDOM.createRoot(document.getElementById("root"));
...
//     Top heading using Functional Component 🚀
//   </h1>
// );
...
const HeadingComponent = () => (
  <>
    <div id="container">
      <Title />
      <h1 className="heaidng">Sub - heading Fucntional Component</h1>
    </div>
